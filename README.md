...
```
git clone https://github.com/FCAI-CairoUniversity/FCAI_GPA_Calculator_Extension.git
```
...
Special thanks to [Mohamed Hesham](https://github.com/mohesham88) for his valuable contributions and support to this project.